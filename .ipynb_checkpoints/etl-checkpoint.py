...
def process_log_data(spark, input_data, output_data):
    ...
    datasets. extracts columns for songplays table.
    writes the data into parquet files  and will be loaded on s3.
    ...
    log_df = log_df.withColumn('hour', hour('start_time'
            ...
            dayofmonth('start_time')).withColumn('week',
            weekofyear('start_time')).withColumn('weekday',
            dayofweek('start_time')).withColumn('month',
            month('start_time')).withColumn('year', year('start_time'))
    ...
    songplays_table = joined_df.select(
        ...
        col('log_df.userAgent').alias('user_agent'),
                     ...
                     )).withColumn('month', date_format(col('start_time'
                                   ), 'MM')).withColumn('songplay_id',
...
def main():
    ...
    # To use the local file uncomment the following line
    # process_song_data(spark, "data/", output_data)
